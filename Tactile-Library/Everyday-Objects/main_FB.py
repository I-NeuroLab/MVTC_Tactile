                    ...
                    for actv_idx in range(1,2):
                        ...
                        for rep in range(5):
                            ...
                            for temp in zip(Temp_data):
                                ...
                                ckpt_path = save_dir / f"Best_{modelname}_{CV_cnt}_{type_idx}_{args.mode}_{args.output_activation}_fb{args.fbank_n}_b8_mh32.pt"
                                ...
                                attn_path = save_dir / f"Attn_{modelname}_{CV_cnt}_{type_idx}_{args.mode}_{args.output_activation}_fb{args.fbank_n}_b8_mh32.mat"
                                ...
                                baseprefix = f"Attn_{modelname}_{CV_cnt}_{type_idx}_{args.mode}_{args.output_activation}_fb{args.fbank_n}_b8_mh32"
                                ...
                                hist_path = save_dir / f'History_{modelname}_{CV_cnt}_{type_idx}_{args.mode}_{args.output_activation}_fb{args.fbank_n}_b8_mh32.csv'
                                reg_path  = save_dir / f'Reg_{modelname}_{CV_cnt}_{type_idx}_{args.mode}_{args.output_activation}_{args.fbank_n}_b8_mh32.mat'
